...
class HighState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('temperature')) {
        ...
        this.temperature = new Array(20).fill(0);
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.temperature.length !== 20) {
      throw new Error('Unable to serialize array field temperature - length must be 20')
    }
    // Serialize message field [temperature]
    bufferOffset = _arraySerializer.int8(obj.temperature, buffer, bufferOffset, 20);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.temperature = _arrayDeserializer.int8(buffer, bufferOffset, 20)
  ...
  static Resolve(msg) {
    ...
    if (msg.temperature !== undefined) {
      ...
      resolved.temperature = new Array(20).fill(0)
    }
