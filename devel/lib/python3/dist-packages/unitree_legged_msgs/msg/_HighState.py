...
class HighState(genpy.Message):
  _md5sum = "5c0482635da390ec2eb76d3059b8755a"
...
uint16[10] cell_vol        # cell voltage mV"""
  __slots__ = ['levelFlag','commVersion','robotID','SN','bandWidth','mode','progress','imu','gaitType','footRaiseHeight','position','bodyHeight','velocity','yawSpeed','footPosition2Body','footSpeed2Body','temperature','bms','footForce','footForceEst','wirelessRemote','reserve','crc']
  _slot_types = ['uint8','uint16','uint16','uint32','uint8','uint8','float32','unitree_legged_msgs/IMU','uint8','float32','float32[3]','float32','float32[3]','float32','unitree_legged_msgs/Cartesian[4]','unitree_legged_msgs/Cartesian[4]','int8[20]','unitree_legged_msgs/BmsState','int16[4]','int16[4]','uint8[40]','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       levelFlag,commVersion,robotID,SN,bandWidth,mode,progress,imu,gaitType,footRaiseHeight,position,bodyHeight,velocity,yawSpeed,footPosition2Body,footSpeed2Body,temperature,bms,footForce,footForceEst,wirelessRemote,reserve,crc
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.footSpeed2Body:
        _x = val1
        buff.write(_get_struct_3f().pack(_x.x, _x.y, _x.z))
      buff.write(_get_struct_20b().pack(*self.temperature))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.temperature = _get_struct_20b().unpack(str[start:end])
      _x = self
      start = end
      end += 10
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.temperature = numpy.frombuffer(str[start:end], dtype=numpy.int8, count=20)
      _x = self
      start = end
      end += 10
      (_x.bms.version_h, _x.bms.version_l, _x.bms.bms_status, _x.bms.SOC, _x.bms.current, _x.bms.cycle,) = _get_struct_4BiH().unpack(str[start:end])
